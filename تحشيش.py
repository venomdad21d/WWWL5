...
#كـتابة المـلف وتعديل.    :   تايسون فينوم.   اخمط وسمي روحك مطور فرخي 😂
...
#كـتابة المـلف وتعديل.    :  تايسون ص فينوم.   اخمط وسمي روحك مطور فرخي 😂
# اذا انت ابن حرام اخمط 😂
# اي بعدك تريد تخمط ترا من تخمط مراح تنجح
...
@WWWL5.on(admin_cmd(pattern="تايسون(?:\s|$)([\s\S]*)"))
async def permalink(mention):
    await edit_or_reply(mention, f"تايسون مطور سورس فينوم @S_Ml10")
